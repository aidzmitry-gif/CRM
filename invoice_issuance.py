...
async def candidate(session, core, user, deal, data, doc_id=None):
    ...
    basis = {
        ...
        "buyer": buyer_facts,
        "party": {
            "identity_status": "selected", "legal_entity_id": buyer.id,
            "legal_entity_revision": buyer.revision, "legal_name": buyer.legal_name,
            "display_name": buyer.display_name or buyer.name, "legal_entity_unp": buyer.unp,
